            ...
            JFreeChart chart = ChartFactory.createPieChart
             ("Pie Chart ", data, true, true, false);
               ...
               ChartRenderingInfo(new StandardEntityCollection()); 
                 final File file1 = new File("C:/TcatServer7/webapps/examples/jsp/jsp2/ista1/piechart2.png");
                 ChartUtilities.saveChartAsPNG(file1, chart, 600, 400, info);
            
			 %>
			 <jsp:forward page="piechart1.jsp"><jsp:param name="events" value="<%=events%>"/></jsp:forward>
		  <%
			}
			catch (Exception e) {
                 out.println(e);
