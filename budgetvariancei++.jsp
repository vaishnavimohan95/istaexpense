...
Calendar localCalendar = Calendar.getInstance(TimeZone.getDefault());
	  ...
	  ResultSet rs1=null;
		...
		<%
		rs=st.executeQuery("select expensedetails.reason,expensedetails.amount,budgetiplus.details,budgetiplus.amount from expensedetails inner join budgetiplus on expensedetails.reason=budgetiplus.details where expensedetails.events='"+events+"' and date between '"+pdate+"' and '"+date1+"'"); %>
