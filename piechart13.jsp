...
%>
<br><div id="b2">
<form name="myform" method="post" action="piechart12.jsp">
event:<input type="text" name="type1" required>
<input type="submit" value="create chart">
</form></div><br>
<img src="piechart8.png" width="500" height="350"onclick="window.location.reload()" >
<br><br>
<%
	}
