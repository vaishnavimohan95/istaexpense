...
<div class="main">
  ...
  <br><br>
<form name="myform" method="post" action="bankdeposearch.jsp">
<table>
...
<tr><th>EVENT:</th><th><input type="text" name="events"><th></tr><tr></tr>
...
<input type="submit" value="SUBMIT"></form><br><a href="javascript:history.back()"><button>BACK</button></a>
</div>
</div>
</body>
</html>