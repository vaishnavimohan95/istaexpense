...
ResultSet rs=null;%>
<br>
<div id="b3" style="background-color:lightgrey;width:1000px;float:right;color:black"><br><br><center>
<div id="b6" style="width:950px;float:center;color:black">
...
{%>
<jsp:forward page="bankdeposearch1.jsp"/><%
}
if(rs.next())
{%>
...
else{%> <jsp:forward page="bankdeposearch1.jsp"/><%}%>
...
<h4><a href="bankdeposearch1.jsp"><button>back</button></a></h4></ul>
</div><%
}
catch(Exception e)
{
