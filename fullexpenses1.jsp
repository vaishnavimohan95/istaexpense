...
Statement st=con.createStatement();%><h3>EXPENSE DETAILS</h3>
...
<h4><form name="myform" method="post" action="piechart6.jsp"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>"><input type="hidden" name="events">
<input type="submit" value="create chart"></form></h4>
<h4><form name="myform" method="post" action="prevexpense2.jsp"><input type="hidden" name="type">
