...
<ul>
<h4><form name="myform" method="post" action="bankwithsearch2.jsp"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>">
<input type="submit" value="search"></form></h4>
<h4><form name="myform" method="post" action="piechart8.jsp"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>">
