...
Calendar localCalendar = Calendar.getInstance(TimeZone.getDefault());
      ...
      int year = localCalendar.get(Calendar.YEAR);
		...
		ResultSet rs;
		if(pyear<year){
		rs=st.executeQuery("select * from expensedetails where events!='"+events1+"'and events!='"+events2+"' and date between '"+pdate+"' and '"+date1+"'");}
		else{
		 rs=st.executeQuery("select * from expensedetails where events!='"+events1+"'and events!='"+events2+"' and date between '"+pdate+"' and '"+date1+"'");
		}%>
...
<center>
<h4>
<a href="budgetvarianceothers.jsp"><button>budget variance</button></a></h4>
<h4>
...
<h4>
<form name="myform" method="post" action="piechart.jsp"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>"><input type="hidden" name="events" value="others">
<input type="submit" value="create chart"></form></h4>
<h4>
<form name="myform" method="post" action="expenseedit.jsp"><tr><input type="submit" value="edit details"></form></h4>
<h4>
...
<h4>
<a href="expenseentry.jsp"><button>add details</button></a></h4>
<h4> 
<form name="myform" method="post"action="viewbudget.jsp"><input type="submit" value="view budget"></form></h4></li>          
<h4>
