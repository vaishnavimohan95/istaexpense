...
<center>
<div id="b3" style="background-color:lightgrey;width:950px;float:left;color:black"><center>
...
<h4><form name="myform" method="post" action="piechart.jsp"><input type="hidden" name="events"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>">
