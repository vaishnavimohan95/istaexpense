...
<%try
{
	Calendar localCalendar = Calendar.getInstance(TimeZone.getDefault());
		...
		%>
<center>
<form name="myform" method="post" action="expensedb.jsp" onsubmit="return validateForm()">
<table>
...
<tr><th>TYPE:</th><th><input type="text" name="type" required></th></tr><tr></tr>
<tr><th>REASON:</th><th><input type="text" name="reason" required></th></tr><tr></tr>
<tr><th>MODE OF PAYMENT:</th><th><select name="paymode" required>
<option value="cash">cash</option>
  <option value="cheque">cheque</option>
   <option value="DD">DD</option>
</select></th></tr>
<tr><th>CHEQUE/DD no:</th><th><input type="text" name="cdno"></th></tr>
<tr><th>DATE:</th><th><input type="text" name="date" value="<%=year%>-<%=month%>-<%=day%>" required></th></tr><tr></tr>
<br></table><br>
<input type="submit" value="SUBMIT"></form><br><a href="javascript:history.back()">Go Back</a></center>
<%
}
catch(Exception e)
{
