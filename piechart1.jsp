...
String eve=request.getParameter("events");
%>
<div id="b2">
<form name="myform" method="post" action="piechart.jsp">
...
<img src="piechart2.png" width="500" height="350" border="0" usemap="#chart" onclick="window.location.reload()">
<%
	}
