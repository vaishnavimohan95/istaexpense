...
<ul>
<h4>
<form name="myform" method="post" action="budgetvarianceitrix.jsp"><input type="hidden" name="events" value="<%=events%>"><input type="submit" value="budget variance"></form></h4>
<h4>
...
<h4><form name="myform" method="post" action="piechart.jsp"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>"><input type="hidden" name="events" value="<%=events%>">
...
<h4><form name="myform" method="post" action="prevexpense.jsp"><input type="hidden" name="type" value="<%=events%>">
<input type="submit" value="previous year expenses"></form></h4>
<h4><a href="expenseentry.jsp"><button>add details</button></a></h4> 
<h4><form name="myform" method="post" action="viewbudget1.jsp"><input type="hidden" name="events" value="<%=events%>">
<input type="submit" value="view budget"></form></h4>           
<h4><form name="myform" method="post" action="saveexpense.jsp"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>"><input type="hidden" name="events" value="<%=events%>">
