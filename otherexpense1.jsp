...
<h4><form name="myform" method="post" action="piechart6.jsp"><input type="hidden" name="pdate" value="<%=pdate%>"><input type="hidden" name="date1" value="<%=date1%>"><input type="hidden" name="events" value="others">
