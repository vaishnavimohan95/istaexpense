...
<form name="myform" method="post" action="prevbankdepo2.jsp" onsubmit="return validateForm()">
enter th year
from: <input type="text" name="pyear"placeholder="2015">
to: <input type="text" name="year"placeholder="2016">
