...
<%=events%>
	WITHDRAWAL DETAILS
<%
rs=st.executeQuery("select * from bankwithdetails where events='"+events+"' and date between '"+pdate+"' and '"+date1+"'");
total=0;i=1;
if(rs.next())
{%>
<table id="itrix"><h2><tr><th>SNO</th><th>ID</th><th>DATE</th><th>NAME</th><th>EVENT</th><th>AMOUNT</th></tr></h2>
<%
do
{%>
...
{
 rs=st.executeQuery("select * from bankwithdetails where date between '"+pdate+"' and '"+date1+"'");
total=0;i=1;%>
WITHDRAWAL DETAILS
<table id="itrix"><h2><tr><th>SNO</th><th>ID</th><th>DATE</th><th>NAME</th><th>EVENT</th><th>AMOUNT</th></tr></h2>
<%
